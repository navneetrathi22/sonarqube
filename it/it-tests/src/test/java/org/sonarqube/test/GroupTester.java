...
public class GroupTester {
  ...
  @SafeVarargs
  public final WsUserGroups.Group generate(Organizations.Organization organization, Consumer<CreateWsRequest.Builder>... populators) {
  ...
  public List<Group> getGroupsOfUser(Organizations.Organization organization, String userLogin) {
  ...
  public GroupTester assertThatUserIsMemberOf(Organizations.Organization organization, String userLogin, String expectedGroup, String... otherExpectedGroups) {
