...
public class OrganizationTester {
  ...
  private void verifyOrganizationMembership(Organizations.Organization organization, String userLogin, boolean isMember) {
  ...
  private void verifyMembersGroupMembership(String userLogin, Organizations.Organization organization, boolean isMember) {
